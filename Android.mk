...
ifeq ($(NR_OFFICIAL),true)
    LOCAL_CFLAGS += -DTW_DEVICE_VERSION='"-1.0-OFFICIAL"'
else
    LOCAL_CFLAGS += -DTW_DEVICE_VERSION='"-1.0-UNOFFICIAL"'
endif

ifneq ($(NR_MAINTAINER),)
    LOCAL_CFLAGS += -DNR_MAINTAINER='"$(NR_MAINTAINER)"'
else
    LOCAL_CFLAGS += -DNR_MAINTAINER='"AyraHikari"'
endif
